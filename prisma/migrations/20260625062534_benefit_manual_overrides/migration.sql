...
INSERT INTO "new_UserBenefit" ("amount", "createdAt", "id", "matchCategories", "matchText", "name", "notes", "period", "usedManual", "userCardId") SELECT "amount", "createdAt", "id", "matchCategories", "matchText", "name", "notes", "period", "usedManual", "userCardId" FROM "UserBenefit";
